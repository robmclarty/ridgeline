...
import { createStderrHandler, formatProposalHeading } from "./legacy-shared.js"
...
type EnsembleConfig<TDraft> = {
  ...
  /** Model name for runClaudeProcess */
  model: string
...
export const runEnsemble = async <TDraft>(
  config: EnsembleConfig<TDraft>
...
// ---------------------------------------------------------------------------
// Planner ensemble — thin wrapper over runEnsemble
// ---------------------------------------------------------------------------
