...
import { formatProposalHeading } from "./legacy-shared.js"
...
// ---------------------------------------------------------------------------
// Spec ensemble — thin wrapper over runEnsemble
// ---------------------------------------------------------------------------
...
export const runSpecifyEnsemble = async (
  shapeMd: string,
  config: SpecEnsembleConfig,
  ...
  return runEnsemble<SpecifierDraft>({
    label: "Specifying",
    specialists,
