...
import { RidgelineConfig, PhaseInfo, BuildState, ClaudeResult, ReviewVerdict, BuilderInvocation } from "../types.js"
import { createCheckpoint, createCompletionTag } from "../stores/tags.js"
import { recordCost, getPhaseCostUsd, getTotalCost } from "../stores/budget.js"
import { ensureHandoffExists, ensurePhaseHandoffExists } from "../stores/handoff.js"
import { formatIssue } from "../stores/feedback.verdict.js"
import { writeFeedback, archiveFeedback } from "../stores/feedback.io.js"
...
const classifyBuildError = (msg: string): "fatal" | "transient" => {
  const lower = msg.toLowerCase()
  if (FATAL_ERROR_PATTERNS.some((p) => lower.includes(p))) return "fatal"
  return "transient"
}
...
const handleInvokeError = (
  ...
  const classification = classifyBuildError(msg)
...
export const executeBuildPhase = async (
  phase: PhaseInfo,
  config: RidgelineConfig,
  state: BuildState,
  cwd?: string,
